...
public class CraftIRC3Listener extends IRCListener implements EndPoint {
	...
	public void messageIn(RelayedMessage msg) {
		...
		if(name == null) name = msg.getField("username");
	...
	@Override public boolean adminMessageIn(RelayedMessage msg) {return false;}
	@Override public boolean userMessageIn(String user, RelayedMessage msg) {return false;}
